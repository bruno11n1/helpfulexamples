...
public class AdvancedExampleOfUsingStreams {
    private int year;
    ...
    public AdvancedExampleOfUsingStreams(int year, String nationality, String name, String team, int lengthKm, Duration winningTime, int daysInYellow) {
        this.year = year;
    ...
    public static final List<AdvancedExampleOfUsingStreams> tdfWinners = Arrays.asList(
            new AdvancedExampleOfUsingStreams(2006, "Spain", "Óscar Pereiro", "Caisse d'Epargne–Illes Balears", 3657, Duration.parse("PT89H40M27S"), 8),
            new AdvancedExampleOfUsingStreams(2007, "Spain", "Alberto Contador", "Discovery Channel", 3570, Duration.parse("PT91H00M26S"), 4),
            new AdvancedExampleOfUsingStreams(2008, "Spain", "Carlos Sastre", "Team CSC", 3559, Duration.parse("PT87H52M52S"), 5),
            new AdvancedExampleOfUsingStreams(2009, "Spain", "Alberto Contador", "Astana", 3459, Duration.parse("PT85H48M35S"), 7),
            new AdvancedExampleOfUsingStreams(2010, "Luxembourg", "Andy Schleck", "Team Saxo Bank", 3642, Duration.parse("PT91H59M27S"), 12),
            new AdvancedExampleOfUsingStreams(2011, "Australia", "Cadel Evans", "BMC Racing Team", 3430, Duration.parse("PT86H12M22S"), 2),
            new AdvancedExampleOfUsingStreams(2012, "Great Britain", "Bradley Wiggins", "Team Sky", 3496, Duration.parse("PT87H34M47S"), 14),
            new AdvancedExampleOfUsingStreams(2013, "Great Britain", "Chris Froome", "Team Sky", 3404, Duration.parse("PT83H56M20S"), 14),
            new AdvancedExampleOfUsingStreams(2014, "Italy", "Vincenzo Nibali", "Astana", 3661, Duration.parse("PT89H59M06S"), 19),
            new AdvancedExampleOfUsingStreams(2015, "Great Britain", "Chris Froome", "Team Sky", 3360, Duration.parse("PT84H46M14S"), 16),
            new AdvancedExampleOfUsingStreams(2016, "Great Britain", "Chris Froome", "Team Sky", 3529, Duration.parse("PT89H04M48S"), 14 ));
    ...
    public static void main(String args[]) {
        ...
        List<String> winnersOfToursLessThan3500km = tdfWinners
                ...
                .map(AdvancedExampleOfUsingStreams::getName) // Get names of winners
        ...
        List<String> winnersOfToursGreaterThan3500km = tdfWinners
                ...
                .map(AdvancedExampleOfUsingStreams::getName)
                .collect(toList());
        ...
        // limit -
        List<AdvancedExampleOfUsingStreams> winnerObjectsOfToursLessThan3500kmLimit2 = tdfWinners
                .stream()
                .filter(d -> d.getLengthKm() < 3500)
                .limit(2)
                .collect(toList());
        ...
        // skip records
        List<AdvancedExampleOfUsingStreams> skipEveryOtherTDFWinner = tdfWinners
                .stream()
                .skip(2)
                .collect(toList());
        ...
        Optional<AdvancedExampleOfUsingStreams> winner2012 = tdfWinners.stream()
        ...
        Optional<Integer> winnerYear2014 = tdfWinners.stream().
                map(AdvancedExampleOfUsingStreams::getYear)
                .filter(x -> x == 2014)
                .findFirst();
        // winnerYear2014 - 2014
        ...
        int totalDistance = tdfWinners.stream()
                .map(AdvancedExampleOfUsingStreams::getLengthKm)
        ...
        Optional<AdvancedExampleOfUsingStreams> fastestWinner = tdfWinners.stream()
                .min(Comparator.comparingDouble(AdvancedExampleOfUsingStreams::getAveSpeed));
        System.out.println("fastestTDF - " + fastestWinner.get());

        // shorthand
        OptionalDouble fastestTDF = tdfWinners.stream()
                .mapToDouble(AdvancedExampleOfUsingStreams::getAveSpeed)
                .min();
        // fastestTDF - 39.0
        ...
        Map<String, List<AdvancedExampleOfUsingStreams>> namesVsWinner = tdfWinners.stream()
                .collect(groupingBy(AdvancedExampleOfUsingStreams::getName));
        ...
        // join strings
        String allTDFWinnersTeamsCSV = tdfWinners.stream().map(AdvancedExampleOfUsingStreams::getTeam).collect(joining(", "));
        ...
        // grouping
        Map<String, List<AdvancedExampleOfUsingStreams>> winnersByNationality = tdfWinners.stream().collect(groupingBy(AdvancedExampleOfUsingStreams::getNationality));
        ...
        Map<String, Long> winsByNationalityCounting = tdfWinners.stream().collect(groupingBy(AdvancedExampleOfUsingStreams::getNationality, counting()));
